...
run_experiment "Group_P" $CORES_PER_CPU $PAIRS_OF_CORES 1 2 0 
...
run_experiment "Spread_P" $CORES_PER_CPU $PAIRS_OF_CORES 1 2 1 
...
run_experiment "Group_P&L" $CORES_PER_CPU $(($PAIRS_OF_CORES * 2)) $((CORES_PER_CPU * 2)) 1 0 
...
run_experiment "Group_1P_2L" $CORES_PER_CPU $(($PAIRS_OF_CORES * 2)) 1 2 $(($CORES_PER_CPU / 2)) 
...
run_experiment "Spread_P&L" $CORES_PER_CPU $(($PAIRS_OF_CORES * 2)) $(($CORES_PER_CPU * 2)) 1 1 
